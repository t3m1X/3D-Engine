...
bool ModulePhysics3D::Init(JSON_File* conf)
{
	LOG_OUT("Creating 3D Physics simulation");
	bool ret = true;
...
{
	LOG_OUT("Creating Physics environment");
...
{
	LOG_OUT("Destroying 3D Physics simulation");
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const bSphere& sphere, float mass)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const bCube& cube, float mass)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const bCylinder& cylinder, float mass)
{
...
{
	LOG_OUT("Bullet warning: %s", warningString);
}

void DebugDrawer::draw3dText(const btVector3& location, const char* textString)
{
	LOG_OUT("Bullet draw text: %s", textString);
}
